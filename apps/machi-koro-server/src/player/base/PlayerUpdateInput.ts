...
class PlayerUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => EnterpriseUpdateManyWithoutPlayersInput,
  })
  @ValidateNested()
  @Type(() => EnterpriseUpdateManyWithoutPlayersInput)
  @IsOptional()
  @Field(() => EnterpriseUpdateManyWithoutPlayersInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => LandmarkUpdateManyWithoutPlayersInput,
  })
  @ValidateNested()
  @Type(() => LandmarkUpdateManyWithoutPlayersInput)
  @IsOptional()
  @Field(() => LandmarkUpdateManyWithoutPlayersInput, {
    nullable: true,
  })
